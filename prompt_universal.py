...
def generate_agent_prompt(agent_id, agent_data, all_posts, agent_history):
    ...
    {{
      "thought_process": "[First-person inner monologue, 1-2 sentences] Please write according to this logic chain: 1. Recently everyone is discussing..., I think it is credible/incredible; 2. Combined with my personality, my current feeling is...; 3. Therefore I decide...",
      "is_believed": true/false, If you saw news about water pollution in your social circle, do you believe the water is polluted? (Note: If no one in your social circle mentioned this event at all, or if you do not believe it, be sure to fill in false directly!)
      "will_spread": true/false, Do you decide to forward or discuss this 'water pollution'?
      "new_post": "If will_spread is true, please write down the specific post, and the tone needs to fit your character persona. If will_spread is false, please be sure to keep it as an empty string \"\"."
    }}
    """
